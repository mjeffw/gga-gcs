...
export class GgaGcsActorSheet extends api.HandlebarsApplicationMixin(sheets.ActorSheetV2) {
  ...
  static PARTS = {
    header: {
      template: 'systems/gga-gcs/templates/actor/header.hbs',
    },
    tabs: {
    ...
    features: {
      template: 'systems/gga-gcs/templates/actor/features.hbs',
    },
    biography: {
      template: 'systems/gga-gcs/templates/actor/biography.hbs',
    },
    gear: {
      template: 'systems/gga-gcs/templates/actor/gear.hbs',
    },
    spells: {
      template: 'systems/gga-gcs/templates/actor/spells.hbs',
    },
    effects: {
  ...
  async _prepareContext(options) {
    ...
    const context = {
      ...
      // Adding a pointer to CONFIG.GGAGCS
      config: CONFIG.GGAGCS,

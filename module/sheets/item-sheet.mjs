...
export class GgaGcsItemSheet extends api.HandlebarsApplicationMixin(sheets.ItemSheetV2) {
  ...
  static PARTS = {
    header: {
      template: 'systems/gga-gcs/templates/item/header.hbs',
    },
    tabs: {
    ...
    attributesSpell: {
      template: 'systems/gga-gcs/templates/item/attribute-parts/spell.hbs',
    },
    effects: {
